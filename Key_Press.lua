...
Top.Size = UDim2.new(0.15, 0, 0.01, 0)
...
Q.Position = UDim2.new(0.05, 0, 0.05, 0)
...
W.Position = UDim2.new(0.20, 0, 0.05, 0)
...
E.Position = UDim2.new(0.37, 0, 0.05, 0)
...
R.Position = UDim2.new(0.52, 0, 0.05, 0)
...
A.Position = UDim2.new(0.07, 0, 0.28, 0)
...
S.Position = UDim2.new(0.23, 0, 0.28, 0)
...
D.Position = UDim2.new(0.38, 0, 0.28, 0)
...
F.Position = UDim2.new(0.55, 0, 0.28, 0)
...
Shift.Position = UDim2.new(0.05, 0, 0.55, 0)
...
Ctrl.Position = UDim2.new(0.05, 0, 0.75, 0)
...
Space.Position = UDim2.new(0.20, 0, 0.75, 0)
...
LM.Position = UDim2.new(0.36, 0, 0.55, 0)
...
RM.Position = UDim2.new(0.5, 0, 0.55, 0)
